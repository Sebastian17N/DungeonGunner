...
public class MovementToPosition : MonoBehaviour
{
    ...
    {
        MoveRigidBody(movementToPositionArgs.movePosition, movementToPositionArgs.currentPositon,
            movementToPositionArgs.moveSpeed);
    }

    private void MoveRigidBody(Vector3 movePosition, Vector3 currentPositon, float moveSpeed)
    {
        Vector2 unitVector = Vector3.Normalize(movePosition - currentPositon);
